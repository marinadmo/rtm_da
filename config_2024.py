...
date = '20240107' # Date for DA analysis
...
sat_data_dir = f"{main_data_dir}atlems/topaz_l3/{date[0:4]}" #2024 # AMSR2 daily means
#sat_data_dir = f"{main_data_dir}atlems/topaz_l3/new_20240919/" #2024 # AMSR2 daily means
# RTM input
...
### OUTPUT DATA
# RTM output
rtm_tbs_dir = f"{main_data_dir}marina/topaz_tbs/{date}/tbs_{fdays}fdays{opt}/" # RTM TOPAZ TBs directory
coeffs_filename = f"{main_data_dir}marina/coefficients/coefficients_files/coefficients_{date}.csv"
#f"{main_data_dir}marina/topaz_tbs/coefficients_files/coefficients_{date}.csv" # file name that will contain 2D-plane coefficients
# EnKF output
